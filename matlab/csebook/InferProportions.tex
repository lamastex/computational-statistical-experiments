...
\begin{equation*}
\overline{X}_{n}\longrightarrow _{p}\mu
\end{equation*}%
...
\begin{eqnarray}
\widehat{\theta}_{n} &=&\overline{X}_{n}=n^{-1}\sum_{i=1}^{n}X_{i}=n^{-1}S_{n},  \notag \\
\sqrt{n}\frac{\left( \widehat{\theta}_{n}-\theta\right) }{\sqrt{\theta(1-\theta)}} &=&  \notag \\
...
\begin{eqnarray*}
\E S_{n} &=&nE\overline{X}_{n}\text{ and }\V(S_{n})=n^{2}\V(%
...
the standard confidence interval for $p$ (i. e. in order to show (\ref%
